<template>
  <div
    class="bg-primary text-white text-xl min-h-screen flex justify-center items-center m-0 py-16 px-6"
  >
    <div class="mx-auto w-full max-w-2xl">
      ...
      >
        <svg
          ...
          viewBox="0 0 24 24"
          class="inline-block w-6 h-6 mr-3 -mt-1"
        >
        ...
        <span class="leading-none">GreenRoutes</span>
      </div>
      <h1 class="block font-black leading-tight text-5xl md:text-6xl pb-16">
      ...
      <form @submit.prevent="handleForm">
        ...
        <input
          ...
          type="text"
          name="start"
          class="rounded rounded-r-none py-4 px-8 w-10/12 text-gray-800"
          placeholder="Current location"
        /><button
          type="submit"
          class="w-2/12 p-4 rounded rounded-l-none bg-secondary"
        >
          &rarr;
        </button>
      </form>
...
label[for='start']:before {
  ...
  @apply inline-block w-5 h-5 mr-4;
}
</style>
